...
export const sidebar: DefaultTheme.Config['sidebar'] = {
  '/games/pc/': getItems("games/pc"),
  '/games/mobile/': getItems("games/mobile"),
 ...
 * 
 * /games/issues/2022/07/20/xxx.md
 * 
 * @param path 扫描基础路径
 ...
 * /product/pcgame/01-经典单机/01-轩辕剑壹.md
 * @param path 扫描基础路径
 * @returns {DefaultTheme.SidebarItem[]}
 */
...
function getOneItems (path: string) {
  // 侧边栏分组数组
  let groups: DefaultTheme.SidebarItem[] = [];
  // 侧边栏分组下标题数组
  let items: DefaultTheme.SidebarItem[] = [];
